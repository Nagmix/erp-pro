  ...
  return (
    <div className="erp-page-enter space-y-5" dir="rtl">
      <PageHeader
        ...
        description="إدارة إعدادات التصنيع ومحطات العمل والتكاليف"
        iconify="solar:settings-bold-duotone"
        accent="destructive"
        breadcrumbs={[{ label: 'التصنيع', href: '/manufacturing/dashboard' }, { label: 'الإعدادات' }]}
      />
        ...
        <TabsContent value="general">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mt-4">
            <SettingsCard
              ...
              title="محطات العمل"
              description="إعداد وإدارة محطات العمل والإنتاج"
              href="/manufacturing/workstations"
            />
            <SettingsCard
              icon="solar:bill-list-bold-duotone"
              title="تكاليف إضافية"
              description="إدارة التكاليف الإضافية والقيود"
              href="/manufacturing/landed-cost-voucher"
            />
          </div>
        </TabsContent>
      </Tabs>
