        ...
        <DialogContent dir="rtl" className="max-w-lg p-5 gap-0">
          ...
          <div className="space-y-4 max-h-[65vh] overflow-y-auto">
            <fieldset className="rounded-2xl border border-border/40 overflow-hidden">
              ...
              <div className="p-4 space-y-4 bg-card/50">
                <div className="space-y-1.5">
                  <Label className="text-[13px] font-semibold">اسم المحطة <span className="text-destructive text-xs">*</span></Label>
                ...
                <div className="space-y-1.5">
                  <Label className="text-[13px] font-semibold">نوع المحطة</Label>
            ...
            <fieldset className="rounded-2xl border border-border/40 overflow-hidden">
              ...
              <div className="p-4 space-y-4 bg-card/50">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-[13px] font-semibold">سعر الساعة</Label>
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-[13px] font-semibold">السعة الإنتاجية</Label>
            ...
            <fieldset className="rounded-2xl border border-border/40 overflow-hidden">
              ...
              <div className="p-4 space-y-4 bg-card/50">
                <div className="space-y-1.5">
                  <Label className="text-[13px] font-semibold">مستودع افتراضي</Label>
                ...
                <div className="space-y-1.5">
                  <Label className="text-[13px] font-semibold">قائمة العطلات</Label>
        ...
        <DialogContent dir="rtl" className="max-w-lg p-5 gap-0">
          ...
          <div className="space-y-4 max-h-[65vh] overflow-y-auto">
            <fieldset className="rounded-2xl border border-border/40 overflow-hidden">
              ...
              <div className="p-4 space-y-4 bg-card/50">
                <div className="space-y-1.5">
                  <Label className="text-[13px] font-semibold">كود المحطة</Label>
