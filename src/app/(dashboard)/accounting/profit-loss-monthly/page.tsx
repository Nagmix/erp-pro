...
import { buildFinancialStatementFilters } from '@/lib/reports/financial-filters';
...
export default function ProfitLossMonthlyPage() {
  ...
  // Separate income and expense rows from normalized data
  const { incomeRows, expenseRows } = useMemo(() => {
    ...
    for (const row of normalized.rows) {
      ...
      if (rootType === 'Income') income.push(r);
      else if (rootType === 'Expense') expense.push(r);
    }
    return { incomeRows: income, expenseRows: expense };
  }, [normalized.rows]);
  ...
  return (
    <div className="erp-page-enter space-y-5" dir="rtl">
      ...
      <div className="space-y-4">
        ...
        {/* Income vs Expense tables using normalized data */}
                  ...
                  <Table>
                    <TableHeader className="sticky top-0 z-10 bg-muted/90 backdrop-blur">
                      <TableRow>
                        ...
                        <TableHead className="text-[11px] font-semibold text-start" dir="ltr">الإجمالي</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
