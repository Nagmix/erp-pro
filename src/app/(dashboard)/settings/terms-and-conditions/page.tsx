  ...
  const columns: Column<TermsRow>[] = useMemo(
    () => [
      ...
      },
      {
        ...
        render: (v) =>
          Number(v) === 1 ? (
            <Badge variant="outline" className="text-[10px] gap-1 px-1.5 py-0 h-5 border-sky-300 text-sky-700 bg-sky-50">
        ...
        render: (v) =>
          Number(v) === 1 ? (
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-rose-600">معطل</span>
            </div>
          ) : (
            <div className="flex items-center gap-1">
      ...
      <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
        <DialogContent dir="rtl" className="sm:max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg border border-border/40 bg-white p-4 overflow-y-auto max-h-[60vh]">
