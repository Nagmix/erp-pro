...
function statusBadge(status: IntegrationStatus) {
 ...
 case 'error':
  return (
  <Badge variant="outline" className="text-[10px] gap-1 px-1.5 py-0 h-5 border-destructive/30 text-destructive bg-destructive/5">
...
export default function SettingsIntegrationsPage() {
 ...
 <div dir="rtl" className="erp-page-enter space-y-5">
  ...
  <CardContent className="p-4 space-y-3">
   <div className="flex items-center gap-2">
   <Settings className="h-4 w-4 text-chart-5 shrink-0" />
