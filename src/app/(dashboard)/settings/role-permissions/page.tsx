                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0 space-y-1">
                          <div className="flex items-center gap-2">
                            ...
                            {isActive ? (
                              <span className="inline-flex items-center rounded-full px-1.5 py-0.5 text-[10px] font-medium bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 ring-1 ring-inset ring-emerald-500/25">
                                مفعّل
                              </span>
                            ) : (
          ...
          {selectedRole && selectedRoleData ? (
            <Card className="border-border/40 shadow-sm">
              <CardContent className="p-4 lg:p-5">
                ...
                {hasUnsaved && (
                  <div className="mb-4 px-3 py-2 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 text-xs font-medium flex items-center gap-2">
                                ...
                                <td key={key} className="px-1.5 py-2 text-center">
                                  <button
                                    ...
                                    className={`
                                      ...
                                      ${
                                        isChecked
                                          ? 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 ring-1 ring-inset ring-emerald-500/30 hover:bg-emerald-500/25'
                                          : 'bg-red-500/8 text-red-400 dark:text-red-500 ring-1 ring-inset ring-red-500/15 hover:bg-red-500/15'
                                      }
                                    `}
