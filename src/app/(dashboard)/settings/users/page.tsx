...
const ROLE_COLORS: Record<string, string> = {
  'System Manager': 'bg-rose-500/10 text-rose-700 dark:text-rose-400 ring-rose-500/25',
  'Administrator': 'bg-red-500/10 text-red-700 dark:text-red-400 ring-red-500/25',
  'Accounts Manager': 'bg-amber-500/10 text-amber-700 dark:text-amber-400 ring-amber-500/25',
  'Accounts User': 'bg-amber-500/10 text-amber-600 dark:text-amber-400 ring-amber-500/25',
  'Sales Manager': 'bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 ring-emerald-500/25',
  'Sales User': 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 ring-emerald-500/25',
  'Purchase Manager': 'bg-sky-500/10 text-sky-700 dark:text-sky-400 ring-sky-500/25',
  'Purchase User': 'bg-sky-500/10 text-sky-600 dark:text-sky-400 ring-sky-500/25',
  'Stock Manager': 'bg-violet-500/10 text-violet-700 dark:text-violet-400 ring-violet-500/25',
  'Stock User': 'bg-violet-500/10 text-violet-600 dark:text-violet-400 ring-violet-500/25',
  'HR Manager': 'bg-pink-500/10 text-pink-700 dark:text-pink-400 ring-pink-500/25',
  'HR User': 'bg-pink-500/10 text-pink-600 dark:text-pink-400 ring-pink-500/25',
  'Manufacturing Manager': 'bg-orange-500/10 text-orange-700 dark:text-orange-400 ring-orange-500/25',
  'Manufacturing User': 'bg-orange-500/10 text-orange-600 dark:text-orange-400 ring-orange-500/25',
  'POS User': 'bg-teal-500/10 text-teal-700 dark:text-teal-400 ring-teal-500/25',
  'Report Manager': 'bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 ring-cyan-500/25',
  'Website User': 'bg-slate-500/10 text-slate-700 dark:text-slate-400 ring-slate-500/25',
  'Desk User': 'bg-gray-500/10 text-gray-700 dark:text-gray-400 ring-gray-500/25',
};
      ...
      >
        ...
        {removable && onRemove && (
          <button
            type="button"
            onClick={onRemove}
            className="ms-0.5 inline-flex h-3.5 w-3.5 items-center justify-center rounded-full hover:bg-black/10 dark:hover:bg-white/10"
          >
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="text-center">
                        {user.enabled ? (
                          <Badge variant="outline" className="text-[10px] border-0 bg-emerald-500/10 text-emerald-700 dark:text-emerald-400">
                            نشط
                          </Badge>
                        ) : (
                          <Badge variant="outline" className="text-[10px] border-0 bg-rose-500/10 text-rose-700 dark:text-rose-400">
                            معطّل
                          </Badge>
                        )}
                      </TableCell>
          ...
          {roleDialogUser && (
            <div className="space-y-4 py-2">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/20 border border-border/30">
                <div className="h-10 w-10 shrink-0 rounded-full bg-sky-500/10 text-sky-700 dark:text-sky-400 flex items-center justify-center font-bold text-sm">
