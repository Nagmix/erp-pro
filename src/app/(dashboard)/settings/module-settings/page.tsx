...
const moduleLinks = [
  ...
  },
  {
    ...
    icon: Store,
    color: 'bg-emerald-500/10 text-emerald-800 dark:text-emerald-200',
  ...
  },
  {
    ...
    icon: Factory,
    color: 'bg-teal-500/10 text-teal-800 dark:text-teal-200',
  ...
  },
  {
    ...
    icon: Heart,
    color: 'bg-pink-500/10 text-pink-800 dark:text-pink-200',
  ...
  },
  {
    ...
    icon: BarChart3,
    color: 'bg-violet-500/10 text-violet-800 dark:text-violet-200',
