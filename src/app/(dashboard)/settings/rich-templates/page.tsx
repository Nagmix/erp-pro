...
const MODULE_COLORS: Record<string, string> = {
 'المبيعات': 'bg-primary/10 text-primary ring-chart-3/25',
 'المشتريات': 'bg-chart-1/10 text-chart-1 ring-chart-1/25',
 'المحاسبة': 'bg-chart-2/10 text-chart-2 ring-chart-2/25',
 'المخزون': 'bg-chart-5/10 text-chart-5 ring-chart-5/25',
 'الموارد البشرية': 'bg-chart-5/10 text-chart-5 ring-chart-5/25',
 'التصنيع': 'bg-chart-4/10 text-chart-4 ring-chart-4/25',
   ...
   <TableBody>
    ...
    filteredTemplates.map((template) => {
     ...
     >
      ...
      {template.use_html ? (
       <Badge variant="outline" className="text-[10px] border-0 bg-chart-2/10 text-chart-2">
  ...
  <DialogContent className="sm:max-w-[650px]" dir="rtl">
   ...
   <div className="space-y-4 py-2">
    ...
    <div className="space-y-1">
     ...
     <Badge variant="outline" className={`text-[10px] border-0 ${previewTemplate.use_html ? 'bg-chart-2/10 text-chart-2' : 'bg-muted/50 text-muted-foreground'}`}>
