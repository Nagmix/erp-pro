  ...
  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
   ...
   return (
    ...
    className={`relative overflow-hidden transition-all duration-200 hover:shadow-md cursor-pointer group ${
     isDefault
     ? 'border-chart-2/30 bg-chart-2/5/30 ring-1 ring-chart-2/30'
    ...
    {/* Default badge */}
    {isDefault && (
     <div className="absolute top-0 start-0 end-0 h-1 bg-gradient-to-l from-chart-2 to-chart-2" />
    )}
    ...
    <CardHeader className="pb-3 pt-4 px-4">
     ...
     <div className="flex items-center gap-1 shrink-0">
      {isDefault && (
      <Badge variant="outline" className="text-[10px] border-chart-2/30 bg-chart-2/10 text-chart-2 gap-1">
    ...
    <CardContent className="px-4 pb-4 pt-0 space-y-2.5">
     ...
     {!isDefault && (
      ...
      variant="ghost"
      size="sm"
      className="h-7 text-[11px] gap-1 flex-1 text-chart-2 hover:text-chart-2 hover:bg-chart-2/5"
  ...
  <DialogContent dir="rtl" className="max-w-2xl max-h-[90vh] overflow-y-auto">
   ...
   <div className="py-4 space-y-5">
    ...
    <div>
     ...
     {selectedCompany.name === resolvedDefault && (
      <Badge variant="outline" className="text-[11px] border-chart-2/30 bg-chart-2/10 text-chart-2 gap-1">
      <Star className="h-2.5 w-2.5 fill-current" />
      الشركة الافتراضية
      </Badge>
     )}
