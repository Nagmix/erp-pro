...
const GATEWAY_TYPE_COLORS: Record<string, string> = {
 'PayPal': 'bg-chart-1/10 text-chart-1',
 'Stripe': 'bg-chart-5/10 text-chart-5',
 'Razorpay': 'bg-chart-2/10 text-chart-2',
 'Braintree': 'bg-chart-3/10 text-chart-3',
   ...
   return (
    ...
    <CardContent className="p-4 space-y-3">
     ...
     {Number(gw.is_default) === 1 && (
      <Badge variant="outline" className="text-[10px] border-0 bg-chart-2/10 text-chart-2 shrink-0">
