    ...
    return (
     ...
     <CardContent className="p-4 space-y-3">
      ...
      <div className="flex items-center gap-1.5">
       {status === 'connected' ? (
       <Badge variant="outline" className="text-[10px] border-0 bg-primary/10 text-primary gap-1">
        <Wifi className="h-3 w-3" /> متصل
       </Badge>
       ) : status === 'error' ? (
       <Badge variant="outline" className="text-[10px] border-0 bg-destructive/10 text-destructive gap-1">
