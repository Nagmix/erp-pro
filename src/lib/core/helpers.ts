...
export const SYSTEM_MODULES: SystemModule[] = [
  {
    ...
    subModules: [
      ...
      { id: 'treasury-transfer', name: 'Treasury Transfer', nameAr: 'التحويل بين الخزائن', path: '/accounting/treasury-transfer' },
      { id: 'treasury-closing', name: 'Treasury Closing', nameAr: 'الإغلاق اليومي للخزنة', path: '/accounting/treasury-closing' },
      { id: 'daily-expenses', name: 'Daily Expenses', nameAr: 'المصاريف اليومية', path: '/accounting/daily-expenses' },
      ...
      { id: 'period-closing', name: 'Period Closing', nameAr: 'إقفال الفترة', path: '/accounting/period-closing' },
      { id: 'deferred-revenue', name: 'Deferred Revenue', nameAr: 'الإيرادات المؤجلة', path: '/accounting/deferred-revenue' },
